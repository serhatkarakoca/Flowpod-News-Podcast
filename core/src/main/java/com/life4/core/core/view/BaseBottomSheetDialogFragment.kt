        ...
        dialog.setOnShowListener {
            ...
            bottomSheet?.let { frameLayout ->
                ...
                when (screenSize) {
                    ...
                    ScreenSize.HALF_SCREEN -> {
                        layoutParams.height = getWindowHeight() / Constant.NUMBER_TWO
                    }
                    ScreenSize.CURRENT -> {
                        // Not necessary
                    }
